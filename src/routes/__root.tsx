...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "Loans" },
      { property: "og:title", content: "Loan & Debt Tracker" },
      { property: "og:description", content: "Track loans and debts with daily snapshots and smart payoff suggestions." },
